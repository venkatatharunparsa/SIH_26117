# Open-Source Agentic AI Repository Atlas

You asked for a much stronger result than the supplied list. The important improvement is not merely adding more GitHub links—it is separating **agent applications, durable workflows, company memory, protocols, security, sandboxes, skills, evaluation, and deployment** so you can assemble a real autonomous operating system rather than a fragile chatbot.
...
DeerFlow is the best single repository to study first. Its current repository shows active work around run-event contracts, checkpoint storage, incremental agent-scoped memory, browser control, Kubernetes sandbox provisioning, skill review gates, and database-backed custom agents. [github](https://github.com/bytedance/deer-flow)

Onyx is particularly valuable when the first problem is connecting agents safely to company systems. Its repository documents hybrid retrieval, custom agents, actions, code execution, deep research, more than 50 connectors, deployment through Docker/Kubernetes/Helm, and MIT-licensed Community Edition features. [github](https://github.com/onyx-dot-app/onyx)
...
**DeerFlow** — best broad implementation of a modern long-horizon agent harness. [github](https://github.com/bytedance/deer-flow)

### If you want a company brain

**GBrain** — strongest Git-backed, graph-aware, cited institutional-memory direction. [github](https://github.com/garrytan/gbrain)

### If you want enterprise connectors

**Onyx** — strongest starting point for access-aware company search and agent actions. [github](https://github.com/onyx-dot-app/onyx)

### If you want context engineering

**OpenViking** — strongest dedicated context database direction, with hierarchical retrieval and memory/resource/skill unification. [github](https://github.com/volcengine/OpenViking)
...
**MCP + A2A + Agentgateway** — tool access, agent interoperability, authentication, policy, routing, and observability. [github](https://github.com/agentgateway/agentgateway)
